...
/**
 * Test Class For ConnectionManager Class Methods
 * 
 * @author Rahul Kumar
 *
 */
public class ConnectionDAOTest {
	...
	public void executeQueryTest_IsBookIssue_True() throws SQLException {
		...
		int size = 0;
		ResultSet resultSet = ConnectionManager.getInstance().executeQuery(stmt);
		if (resultSet != null) {
	...
	public void executeQueryTest_True_Exception() throws SQLException {
		...
		assertEquals(expected, ConnectionManager.getInstance().executeQuery(stmt));
	}
	...
	public void deleteBooksTest_True() throws SQLException {
		...
		assertEquals(expected, ConnectionManager.getInstance().deleteBooks(stmt));
	}
	...
	public void deleteBooksTest_False() throws SQLException {
		...
		assertNotEquals(expected, ConnectionManager.getInstance().deleteBooks(stmt));
	}
	...
	public void executeQueryTest_getBooksTitlesByAuthorName_True() throws SQLException {
		...
		ResultSet result = ConnectionManager.getInstance().executeQuery(stmt);
		result.next();
